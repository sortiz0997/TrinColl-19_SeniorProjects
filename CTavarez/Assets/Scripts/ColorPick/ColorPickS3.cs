 ...
 * 
 * This script allows for the hue change of an object based on the image on a slider at 30% saturation */

using UnityEngine;
using UnityEngine.UI;

public class ColorPickS3 : MonoBehaviour
{
    // Slider components
    ...
    {
        this.sliderHandle.color = Color.HSVToRGB(value, 0.3f, 1);
    }
    ...
    private Texture2D ColorStrip(int density)
    {
        ...
        {
            colors[k] = Color.HSVToRGB((1.0f * k) / density, 0.3f, 1);
        }
