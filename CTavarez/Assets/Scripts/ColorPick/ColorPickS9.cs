 ...
 * 
 * This script allows for the hue change of an object based on the image on a slider at 90% saturation */

using UnityEngine;
using UnityEngine.UI;

public class ColorPickS9 : MonoBehaviour
{
    // Slider components
    ...
    {
        this.sliderHandle.color = Color.HSVToRGB(value, 0.9f, 1);
    }
    ...
    private Texture2D ColorStrip(int density)
    {
        ...
        {
            colors[k] = Color.HSVToRGB((1.0f * k) / density, 0.9f, 1);
        }
