 ...
 * 
 * This script allows for the shade change of an object based on the image on a slider */

using UnityEngine;
using UnityEngine.UI;

public class MonoPick : MonoBehaviour
{
    // Slider components
    ...
    {
        // Build our texture
        this.colorTex = this.ColorStrip(100);
    ...
    {
        this.sliderHandle.color = Color.HSVToRGB(0, 0, value);
    }
    ...
    private Texture2D ColorStrip(int density)
    {
        ...
        {
            colors[k] = Color.HSVToRGB(0, 0, (1.0f * k) / density);
        }
